...
Supplier.create(name: "Tops", email: "tops@email.com", phone_number: "3424324")
Supplier.create(name: "Bottoms", email: "bottoms@email.com", phone_number: "3424324")
Supplier.create(name: "Regulars", email: "regulars@email.com", phone_number: "3424324")

Product.create(name: "Cabella's Boots", price: 105, description: "Nice pair of waterproof boots", supplier_id: 3)
Product.create(name: "Sketchers", price: 65, description: "Skechers GOwalk platform, the Skechers On The GO", supplier_id: 3)
Product.create(name: "Dr. Martens", price: 250, description: "Good for all weather and terrain", supplier_id: 3)
Product.create(name: "New Balance", price: 135, description: "Keep up the pace in this running shoe from New Balance.", supplier_id: 1)
